...
export default function CXMaturity() {
  ...
  return (
    <div style={{ fontFamily: FONT, minHeight: "100vh" }}>
      ...
      {/* ═══ GATE ═══ */}
      {phase !== "intro" && <ToolHero compact wrap={WRAP} eyebrow="Assessments + Scorecards" title="CX Maturity Assessment" />}
      {phase === "intro" && (
        <ToolHero fill wrap={WRAP} eyebrow="Assessments + Scorecards" title="CX Maturity Assessment"
          intro="Score your organization across 5 dimensions: strategy, operations, technology, analytics and governance. 25 statements, about 5 minutes. The result places you on a published rubric and lists the actions your answers call for.">
          <ToolStart label="Start Assessment" onStart={handleStart} methodHref={RUBRIC.methodology} methodLabel="See the published rubric: every statement, weight and band" />
        </ToolHero>
      )}
        ...
        <section style={{ background: WARM, minHeight: "calc(100vh - 60px)", padding: "48px 28px 80px" }}>
          <div style={WRAP}>
            ...
            <div style={{ background: `linear-gradient(135deg, ${NAVY}, ${DEEP})`, borderRadius: 14, padding: "40px 32px", textAlign: "center", marginBottom: 32 }}>
              <span style={{ color: "rgba(255,255,255,0.72)", fontSize: 11, fontWeight: 700, letterSpacing: 2, textTransform: "uppercase" }}>Your CX Maturity Tier</span>
              ...
              {(() => {
                ...
                return (<>
                  <div style={{ background: `${GREEN}08`, border: `1px solid ${GREEN}20`, borderRadius: 10, padding: "20px" }}>
                    <span style={{ fontSize: 11, fontWeight: 700, color: GREEN, letterSpacing: 1, textTransform: "uppercase" }}>Strongest Dimension</span>
                  ...
                  <div style={{ background: `${AMBER}08`, border: `1px solid ${AMBER}20`, borderRadius: 10, padding: "20px" }}>
                    <span style={{ fontSize: 11, fontWeight: 700, color: AMBER, letterSpacing: 1, textTransform: "uppercase" }}>Biggest Opportunity</span>
