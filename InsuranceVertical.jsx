    ...
    <div><Nav />
      ...
      <section style={{ background: "#fff", padding: "80px 28px" }}><div style={WRAP}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(340px, 1fr))", gap: 14, marginTop: 24 }} className="sub-grid">
          {[
            { name: "NICE CXone", why: "WEM and compliance controls for regulated insurance environments. Strong QA for claims interactions. Analytics for E&O risk monitoring.", href: "/vendors/nice-cxone" },
            { name: "Genesys", why: "Deepest routing for multi-line carriers. CAT surge routing, FNOL priority, and licensed-agent matching. Proven at major P&C carriers globally.", href: "/vendors/genesys" },
            ...
            { name: "Five9", why: "Strong Salesforce integration for carriers using FSC. Practical AI for policy servicing and billing. Good mid-market to enterprise fit.", href: "/vendors/five9" },
            ...
            { name: "Content Guru", why: "Strong in UK/EMEA insurance markets. storm platform handles the regulatory complexity of multi-jurisdiction insurance operations.", href: "/vendors" },
