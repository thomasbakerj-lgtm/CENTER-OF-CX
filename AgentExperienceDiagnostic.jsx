        ...
        <section style={{ background: "#fff", padding: "40px 28px 60px" }}>
          <div style={WRAP}>
            ...
            <div style={{ display: "flex", gap: 12, flexWrap: "wrap" }}>
                ...
                <ReportExport toolName="Agent Experience Diagnostic" subtitle={"Score: " + overallScore.toFixed(1) + "/5 — " + tier.tier} userName={name} userEmail={email} sections={[
                    { title: "Dimension Scores", type: "table", rows: DIMS.map(d => [d.name, dimScore(d.id).toFixed(1) + "/5"]) },
                    { title: "Overall Assessment", type: "metrics", items: [
                      { label: "Overall Score", value: overallScore.toFixed(1) + "/5", color: tier.color },
                      { label: "Classification", value: tier.tier, color: tier.color },
                    ]},
                    { title: "Key Findings", type: "findings", items: [
                      "Overall agent experience score: " + overallScore.toFixed(1) + "/5 (" + tier.tier + ").",
                      tier.desc,
                    ...
                    { title: "Next Steps", type: "next", items: [
                      { tool: "Attrition Cost Calculator", reason: "Calculate what this experience level costs in turnover" },
                      { tool: "The Human Premium", reason: "Career growth strategies for agent retention" },
                    ]},
                  ]} />
