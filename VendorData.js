...
export const vendors = {
  ...
  // ═══════════════════════════════════════════════════════════
  // STRATEGIC FOUNDATION (85 to 100)
  // ═══════════════════════════════════════════════════════════
  ...
  "five9": {
    ...
    bestFit: "Mid-market to enterprise contact centers (100 to 1000+ seats) seeking a reliable, well-integrated platform. Strong for blended service/sales operations, Salesforce shops, and pragmatic enterprise modernization.",
  ...
  // ═══════════════════════════════════════════════════════════
  // SITUATIONAL SPECIALIST (55 to 69)
  // ═══════════════════════════════════════════════════════════
  ...
  "avaya": {
    ...
    strengths: [
      ...
      "Strong enterprise gravity: the organizational inertia of its installed base keeps Avaya relevant",
    ],
    weaknesses: [
  ...
  "alvaria": {
    ...
    redFlags: ["Treat as a specialist choice and evaluate whether outbound depth justifies a narrower platform foundation"],
...
// Alphabetical. Phase 1 scores stay in this file as history but no longer order any
// public list (integrity freeze, 23 Sep 2026).
export const getCoreVendors = () => Object.values(vendors).filter(v => v.categorySlug === "ccaas").sort((a,b) => a.name.localeCompare(b.name));
