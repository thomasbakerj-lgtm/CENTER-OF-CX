...
export const deTierConfig = {
  "Leader": { color: "#10B981", range: "82 to 94", desc: "Full orchestration, deep AI, multi-channel mastery, and enterprise scale. These platforms can anchor serious digital engagement programs." },
  "Strong": { color: "#0088DD", range: "74 to 80", desc: "Meaningful capability with clear strengths but uneven depth across all dimensions. Strong in defined motions." },
  "Mid": { color: "#F59E0B", range: "59 to 72", desc: "Functional for defined use cases but lacking the breadth or depth for enterprise digital operations." },
  "Niche": { color: "#EF4444", range: "52 to 64", desc: "Vertical specialists, social-only tools, or legacy platforms. Useful in narrow lanes." },
  "SMB": { color: "#7C3AED", range: "45 to 56", desc: "Lightweight tools for small teams. Simple onboarding, limited orchestration, minimal enterprise relevance." },
};
