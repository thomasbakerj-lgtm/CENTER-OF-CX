            ...
            <FadeIn key={i} delay={i * 0.08}>
              <a href={a.href || "#"} style={{ display: "block", border: `1px solid ${BORDER}`, borderRadius: 12, overflow: "hidden", cursor: "pointer", transition: "all 0.22s", height: "100%", textDecoration: "none", color: "inherit" }}
                ...
                <div style={{ padding: "32px 28px" }}>
                  ...
                  <span style={{ fontSize: 13, fontWeight: 600, color: ELECTRIC, fontFamily: "'DM Sans', sans-serif" }}>{a.href ? "Access Guide →" : "Read →"}</span>
                </div>
              </a>
            </FadeIn>
          ))}
...
function AllArticles() {
  const articles = [
    { tag: "Operator Briefing", color: "#389E0D", read: "10 min", title: "What 50 to 70% Automation Actually Requires", desc: "The target-state numbers are everywhere. The operational prerequisites are rarely discussed. Here's what your data, workflows, governance, and team structure need to look like before automation at that level becomes realistic." },
    ...
    { tag: "CX Reality Check", color: "#D4380D", read: "7 min", title: "Payment Friction Is Your Silent Cost Center", desc: "Payment issues drive 3 to 12% of all inbound contact volume. Most organizations don't measure this because it spans CX, IT, and finance. Here's the math that makes your CFO pay attention." },
        ...
        <FadeIn>
          <div style={{ textAlign: "center", maxWidth: 520, margin: "0 auto" }}>
            ...
            <div style={{ display: "flex", justifyContent: "center", gap: 14, flexWrap: "wrap" }}>
              ...
              <a href="/contact" style={{ background: "rgba(255,255,255,0.06)", border: "1px solid rgba(255,255,255,0.15)", color: "#fff", fontSize: 15, fontWeight: 500, padding: "14px 28px", borderRadius: 8, fontFamily: "'DM Sans', sans-serif" }}>Connect with a Consultant →</a>
            </div>
          </div>
        </FadeIn>
      </div>
