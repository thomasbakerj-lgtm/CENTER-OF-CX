...
export default function RoadmapBuilder() {
  ...
  return (
    <div style={{ fontFamily: FONT, minHeight: "100vh" }}>
      ...
      {phase !== "intro" && <ToolHero compact wrap={WRAP} eyebrow="Frameworks + Planning" title="Transformation Roadmap Builder" />}

      {phase === "intro" && (
        <ToolHero fill wrap={WRAP} eyebrow="Frameworks + Planning" title="Transformation Roadmap Builder"
          intro="A structured 90-day plan with 18 milestones across three phases, Foundation, Design & Pilot, and Scale & Optimize. Track status, identify dependencies, flag risks, and build the plan you can put in front of leadership.">
          <ToolStart label="Start Building" onStart={handleStart} />
        </ToolHero>
      )}
          ...
          <div style={WRAP}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 24, flexWrap: "wrap", gap: 12 }}>
              <div>
                ...
                <input aria-label="Initiative name" value={initiative} onChange={e => setInitiative(e.target.value)} placeholder="Name your initiative (e.g., CCaaS Migration, AI Deployment)" style={{ padding: "8px 12px", fontSize: 13, border: `1px solid ${BORDER}`, borderRadius: 6, background: "#fff", color: NAVY, width: 380, outline: "none" }} />
              </div>
