...
const CONVERTED = [
  ...
  { file: "InsuranceSubVerticalData.js", kind: "data", exportName: "insuranceSubVerticals", page: "src/lib/SubVerticalPage.jsx" },
  { file: "FinancialServicesVertical.jsx", kind: "jsx" },
  { file: "FSSubVerticalData.js", kind: "data", exportName: "fsSubVerticals", page: "src/lib/SubVerticalPage.jsx" },
  { file: "EducationVertical.jsx", kind: "jsx" },
  { file: "EducationSubVerticalData.js", kind: "data", exportName: "educationSubVerticals", page: "src/lib/SubVerticalPage.jsx" },
