    ...
    layers: [
      ...
      { layer: 6, name: "Routing & Orchestration",
        ...
        stack: [
          ...
          { name: "8x8", role: "UCaaS/CCaaS", why: "Unified communications and contact center on one platform. Ideal for CUs where branch staff and contact center agents need to collaborate in one workflow.", href: "/vendors" },
        ],
  ...
  "insurance": {
    ...
    layers: [
      ...
      { layer: 2, name: "Workflow Execution",
        ...
        stack: [
          { name: "Guidewire", role: "Core Insurance Platform", why: "Widely used claims management (ClaimCenter), policy admin (PolicyCenter), and billing (BillingCenter). Cloud-native Guidewire Cloud is the target platform for most P&C digital transformations.", href: "/vendors" },
