...
export const ivaVendors = {
  ...
  "ibm-watsonx": {
    ...
    summary: "Strong regulated/governance/developer density. Enterprise CAIP with governance emphasis and deep analytics.",
  ...
  "talkdesk-autopilot": {
    ...
    summary: "Generative AI virtual agents for voice and digital channels. CCaaS integration with vertical Experience Clouds.",
