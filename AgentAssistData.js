...
export const aaTierConfig = {
  "Elite": { color: "#10B981", range: "86 to 90", desc: "Default shortlist leaders. Full orchestration, deep real-time guidance, grounded knowledge, workflow execution, and enterprise-grade governance." },
  "Strong": { color: "#0088DD", range: "80 to 85", desc: "Credible finalist pool. Strong in defined motions with clear differentiation, but narrower than the Elite tier in specific dimensions." },
  "Solid": { color: "#3B82F6", range: "76 to 79", desc: "Selective shortlist based on fit. Genuine capability that earns consideration when use case, vertical, or installed base align." },
  "Selective": { color: "#F59E0B", range: "70 to 75", desc: "Use-case or installed-base led. Relevant in specific contexts where buyer priorities match vendor strengths." },
  "Niche": { color: "#EF4444", range: "65 to 69", desc: "Narrow fit or lower category depth. Useful in defined lanes but should be qualified carefully against broader alternatives." },
};
