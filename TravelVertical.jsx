    ...
    <div><Nav />
      ...
      <section style={{ background: "#fff", padding: "80px 28px" }}><div style={WRAP}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(340px, 1fr))", gap: 14, marginTop: 24 }} className="sub-grid">
          {[
            { name: "Genesys", why: "Deepest routing for high-volume, multi-language travel operations. Predictive routing separates disruption calls from routine modifications. Proven at major airlines and hotel chains.", href: "/vendors/genesys" },
            ...
            { name: "Amazon Connect", why: "Pay-per-use pricing ideal for travel's seasonal volume patterns. AWS ecosystem enables custom disruption management solutions.", href: "/vendors/amazon-connect" },
            { name: "Sprinklr", adj: true, why: "Unified social media and digital CX management. Essential for travel brands where disruption complaints play out publicly on social media.", href: "/vendors" },
