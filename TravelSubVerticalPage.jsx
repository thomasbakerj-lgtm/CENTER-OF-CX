...
export default function FSSubVerticalPage() {
  ...
  const sv = getTravelSubVertical(slug);
  ...
  if (!sv) return (
    <div style={{ fontFamily: "'DM Sans', sans-serif", background: "#fff", minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center" }}>
      <div style={{ textAlign: "center" }}><h1 style={{ fontFamily: "'Instrument Serif', Georgia, serif", fontSize: 32, color: NAVY }}>Sub-vertical not found</h1><a href="/industries/travel" style={{ color: ELECTRIC, fontSize: 14, fontWeight: 600 }}>← Back to Travel</a></div>
    </div>
  );
    ...
    <div style={{ fontFamily: "'DM Sans', sans-serif", minHeight: "100vh" }}>
      ...
      <nav style={{ background: DEEP, padding: "16px 0" }}>
        <div style={{ ...WRAP, display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          ...
          <a href="/industries/travel" style={{ color: "rgba(255,255,255,0.5)", fontSize: 13 }}>← Travel</a>
        </div>
      </nav>
