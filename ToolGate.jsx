...
const TOOLS = {
  "cx-maturity": { name: "CX Maturity Assessment", desc: "Score your organization across strategy, operations, technology, analytics, and governance. Get a maturity profile with specific recommendations for advancement.", category: "Calculator & Diagnostic", status: "coming-soon" },
  "ai-readiness": { name: "AI Readiness Diagnostic", desc: "Evaluate whether your data quality, workflow design, integration architecture, and governance posture can support AI-driven automation and agent assist.", category: "Calculator & Diagnostic", status: "coming-soon" },
  "experience-scorecard": { name: "Experience Scorecard", desc: "Benchmark your CSAT, FCR, cost-per-contact, containment rate, and resolution time against industry medians. Identify the metrics where you have the most room to improve.", category: "Framework & Template", status: "coming-soon" },
  "cx-it-alignment": { name: "CX + IT Alignment Framework", desc: "Map the gap between your experience vision and your technology execution. Identify where CX strategy and IT architecture are misaligned and what to prioritize.", category: "Framework & Template", status: "coming-soon" },
  "governance-model": { name: "Governance & Operating Model", desc: "Define ownership across CX strategy, contact center operations, AI programs, and vendor management. Build a governance structure that scales.", category: "Framework & Template", status: "coming-soon" },
  "service-design": { name: "Service Design Toolkit", desc: "Combine journey mapping, effort scoring, and friction analysis into a single diagnostic. Identify the service moments that drive the most cost, churn, and dissatisfaction.", category: "Framework & Template", status: "coming-soon" },
