        ...
        <div style={WRAP}>
          <FadeIn>
            <div style={{ maxWidth: 640, margin: "0 auto", textAlign: "center" }}>
              ...
              <h2 style={{ fontFamily: "'Instrument Serif', Georgia, serif", fontSize: 26, fontWeight: 400, color: NAVY, margin: "8px 0 16px" }}>We research vendors. They cover the industry. Both matter.</h2>
