      ...
      <section style={{ background: "#fff", padding: "80px 28px" }}><div style={WRAP}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(340px, 1fr))", gap: 14, marginTop: 24 }} className="sub-grid">
          {[
            ...
            { name: "NICE CXone", score: 90, why: "WEM for seasonal staffing management. Strong analytics for returns root cause and agent quality during peak periods.", href: "/vendors/nice-cxone" },
            ...
            { name: "Gorgias", score: "adj", why: "Ecommerce-native helpdesk. Deep Shopify integration with order management, returns, and revenue-driving CX built into the agent workflow.", href: "/vendors" },
