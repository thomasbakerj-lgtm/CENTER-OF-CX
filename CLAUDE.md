...
35. Done S23: full site scan part 3 (TB approved three calls). CCaaS buyer guide page no longer shows the Phase 1 scoring
   ...
   ("catches 95%", "40 to 60% of the time"); sub-vertical email gate removed (TB: yes, S23; PR #36): the 61 frameworks open to everyone, reaching the results
   sends nothing, a copy button keeps the profile, and a labelled optional review request is the only send (`copy.test.mjs` 5).
