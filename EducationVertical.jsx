    ...
    <div><Nav />
      ...
      <section style={{ background: WARM, padding: "80px 28px" }}><div style={WRAP}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(340px, 1fr))", gap: 14, marginTop: 24 }} className="sub-grid">
          {[
            { name: "Genesys", why: "Multi-department routing for complex university operations. Handles the breadth, admissions, financial aid, registrar, IT, housing, on one platform with separate SLAs.", href: "/vendors/genesys" },
            { name: "NICE CXone", why: "Strong WEM for managing seasonal education staffing. Student worker scheduling, surge capacity for FAFSA season, and compliance QA for FERPA.", href: "/vendors/nice-cxone" },
            { name: "Five9", why: "Good fit for mid-size institutions. Outbound capability for yield campaigns. Salesforce integration for institutions using Salesforce Education Cloud.", href: "/vendors/five9" },
            { name: "8x8", why: "Right-sized for smaller institutions combining phone system and contact center. UCaaS + CCaaS on one platform. Lower cost for 10-30 agent operations.", href: "/vendors" },
            { name: "Amazon Connect", why: "Pay-per-use pricing ideal for seasonal education volume. AWS Lex for student self-service bots. Good for institutions with cloud engineering capacity.", href: "/vendors/amazon-connect" },
