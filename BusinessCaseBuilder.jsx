...
const DEFS = {
  ...
  containment: "The share of contacts the transformation fully handles in self-service with no agent. It is the lever a board probes first, so the tool sizes it on the handled pool and flags targets above the internal planning ranges.",
