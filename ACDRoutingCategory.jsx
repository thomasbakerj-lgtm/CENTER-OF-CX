                ...
                return (
                  <div key={i} style={{ flex: 1, minWidth: 140 }}>
                    <div style={{ background: `${t.color}08`, border: `1px solid ${t.color}20`, borderRadius: "10px 10px 0 0", padding: "12px 10px", minHeight: heights[i], display: "flex", flexDirection: "column", justifyContent: "flex-end" }}>
                      ...
                      {t.vendors.map((v, j) => (
                        <a key={j} href={`/vendors/${v.slug}`} style={{ display: "flex", justifyContent: "space-between", padding: "2px 0", fontSize: 11, color: SLATE, borderBottom: j < t.vendors.length - 1 ? `1px solid ${BORDER}` : "none", textDecoration: "none", transition: "color 0.15s" }}
            ...
            <FadeIn key={ti} delay={ti * 0.04}>
              <div style={{ marginBottom: 36 }}>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 5 }}>
                  {t.vendors.map((v, vi) => (
                    <a key={vi} href={`/vendors/${v.slug}`} style={{ display: "flex", alignItems: "center", gap: 12, padding: "14px 16px", background: "#fff", border: `1px solid ${BORDER}`, borderRadius: 8, transition: "all 0.2s", textDecoration: "none", color: "inherit", cursor: "pointer" }}
