    ...
    <div><Nav />
      ...
      <section style={{ background: WARM, padding: "80px 28px" }}><div style={WRAP}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(340px, 1fr))", gap: 14, marginTop: 24 }} className="sub-grid">
          {[
            { name: "Genesys", why: "FedRAMP authorized. Deepest routing for multi-agency, multilingual government operations. Proven at federal and state scale. GovCloud deployment.", href: "/vendors/genesys" },
            { name: "NICE CXone", why: "FedRAMP authorized. Strong WEM for managing unionized government workforces. Compliance controls for Section 508 and language access.", href: "/vendors/nice-cxone" },
            { name: "Amazon Connect", why: "AWS GovCloud FedRAMP High. Pay-per-use pricing ideal for government budget constraints. Strong for agencies with AWS cloud commitment.", href: "/vendors/amazon-connect" },
            { name: "Cisco", why: "Massive government installed base. JITC certified for DoD. Strong in agencies with existing Cisco network infrastructure.", href: "/vendors/cisco" },
            { name: "Content Guru", why: "Strong in UK/EMEA public sector. storm platform handles multi-agency, multi-language government operations with data sovereignty controls.", href: "/vendors" },
            { name: "Five9", why: "Growing government presence. FedRAMP in process. Good for state and local agencies seeking modern CCaaS without federal-scale complexity.", href: "/vendors/five9" },
